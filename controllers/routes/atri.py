...
class Atri:
	def __init__(self, state: Any):
		...
		self.restaurent = state["restaurent"]
	...
	@property
	def restaurent(self):
		self._getter_access_tracker["restaurent"] = {}
		return self._restaurent
	@restaurent.setter
	def restaurent(self, new_state):
		self._setter_access_tracker["restaurent"] = {}
		global default_state
		self._restaurent = TextBox(new_state, default_state["restaurent"])
